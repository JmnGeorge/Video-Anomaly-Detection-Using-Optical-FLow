...
classifiers = [
    ...
    MLPClassifier(solver='adam', alpha=1e-5, hidden_layer_sizes=(15, 15), random_state=1, verbose=True)
    ]
...
def load_train_dataset():
    ...
    for files in os.listdir(Train4):
        f = open(Train4 + files, 'r')
        for lines in f:
            lines = lines.split(',')
            i = 0
            x1 = []
...
def load_test_dataset():
    ...
    for files in os.listdir(Test4):
        f = open(Test4 + files, 'r')
        for lines in f:
            lines = lines.split(',')
            i = 0
            x1 = []
